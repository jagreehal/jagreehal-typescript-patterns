...
| [Composition Patterns](./patterns/composition) | Monolithic growth | Small pieces that combine |
...
- [AI Coding Agents](./patterns/ai-agents) - Write effective specs for AI coding agents
- [React Architecture](./patterns/react) - Framework-agnostic React patterns
